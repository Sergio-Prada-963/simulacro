        ...
        <tbody>
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 ">
                <a class="btn btn-danger" href="../backend/acciones/clientes/borrarCliente.php?id=<?= $value['id_cotizacion'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="../backend/acciones/clientes/editarClientes.php?id=<?=$value['id_cotizacion']?>">Editar</a>
              </td>
            </tr>
            <?php  } ?>
