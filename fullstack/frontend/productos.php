<?php 
    ...
    require_once('../backend/config/productos.php');
    $data = new Cofig();
    $all = $data-> obtainAll();
?>
<!DOCTYPE html>
        ...
        <tbody>
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 ">
                <a class="btn btn-danger" href="../backend/acciones/clientes/borrarCliente.php?id=<?= $value['id_productos'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="../backend/acciones/clientes/editarClientes.php?id=<?=$value['id_productos']?>">Editar</a>
              </td>
            </tr>
            <?php  } ?>
